                ...
                <li key={i} className="flex items-start gap-2">
                  ...
                  <div className="min-w-0">
                    <div className="text-sm font-medium text-slate-900 dark:text-slate-100">
                      {s.label}{" "}
                      <span className="text-xs font-normal text-slate-500 dark:text-slate-400">{intervalLabel({ interval_miles: s.interval_miles, interval_months: s.interval_months })}</span>
                    </div>
