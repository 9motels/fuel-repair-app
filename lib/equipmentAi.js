...
export async function webSearchJson({ system, prompt, maxUses = 3, maxResumes = 1 }) {
  const client = getClient();
  // Basic web search (no code-execution-backed dynamic filtering) — the filtering
  // variant runs a sandbox per query and blows past the serverless time limit.
